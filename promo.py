...
SECRET_CODEWORD = "Аня"
PERSON_NAME = "Аня"
PROMO_CODE = "7760 00305 32146 60837  CVC 593"
...
if not st.session_state.authenticated:
    ...
    with col2:
        st.markdown(f"<h3 style='text-align: center; font-family: Calibri;'>Введите кодовое слово.</h3>", unsafe_allow_html=True)
...
# Если пользователь успешно вошел, показываем страницу с промокодом.
    ...
    st.markdown(
        "<p style='text-align: center; font-family: Calibri; font-size: 1.2em;'>Прими от нас этот подарок :)</p>",
        unsafe_allow_html=True
    )
